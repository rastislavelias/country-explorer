export default function Footer() {
  return (
    <footer>
      <p>
        Country Explorer is a React + TypeScript project focused on data
        fetching, filtering, and component structure. Source code on{" "}
        <a
          href="https://rastislavelias.github.io/country-explorer/"
          target="_blank"
        >
          GitHub <NewTabIcon />
        </a>
